...
## Features
khat eases the process of HTML email development by providing you with:
...
khat uses the following to run:
...
## Grid Layouts
The following grid layouts and variations are available:
...
Code and documentation copyright 2016 Pixelative. Code released under [the MIT license](https://raw.githubusercontent.com/arslanakram/khat/master/LICENSE). 